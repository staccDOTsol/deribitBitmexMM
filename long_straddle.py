...
while True:
        ...
        for option in options:
            ...
            for bid in bid_ords:
                if remember[bid['instrument']] not in puts:
                    ...
                    amts[bid['instrument']] = amts[bid['instrument']] + bid['quantity']
    ...
    while abc < len(calls):
        ...
        c2 = black_scholes(spot * 1.05, strikep[abc], diff, ivs[puts[abc]['instrumentName']], 0.03, 0.0, -1) 
        p2 = black_scholes(spot * 1.05, strikec[abc], diff, ivs[calls[abc]['instrumentName']], 0.03, 0.0, 1) 
        c3 = black_scholes(spot * 0.95, strikep[abc], diff, ivs[puts[abc]['instrumentName']], 0.03, 0.0, -1) 
        p3 = black_scholes(spot * 0.95, strikec[abc], diff, ivs[calls[abc]['instrumentName']], 0.03, 0.0, 1) 
        cost1 =(c1 + p1)
        cost2 = (c2 + p2)
        cost3 = (c3 + p3)
