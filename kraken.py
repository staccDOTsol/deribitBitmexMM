...
KEY = "fpAKthc+cfZzh9NBu3aacanCwXKKCpMJEDYrLZA2ypbiwGiCzpFCnmy7"
SECRET = "sp2Eqe0PYW4JXE654ML6sqUGlH5k2JQMw1b7idMOkQbbnTg5Hnz7i2z/69ZOpN9rw4u+O4DFQYh7R7FNBToYqVCD"
import json
...
class MarketMaker( object ):
    ...
    def create_client( self ):
        #b6qb22bq@futures-demo.com
        #chbtgoj6bt1euejkrseti
        self.client = ccxt.kraken({  'enableRateLimit': True,"apiKey": KEY,
    "secret": SECRET})    
        #print(dir(self.client))  
        print(self.client.urls['api'])
        self.client.urls['api']['public'] = 'https://demo-futures.kraken.com'
        self.client.urls['api']['private'] = 'https://demo-futures.kraken.com'
        self.client.version = "derivatives/api/v3"
    ...
    def update_positions( self ):
        ...
        print('positions')
        positions = self.client.privatePostOpenPositions()
